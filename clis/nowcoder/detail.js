...
cli({
    ...
    columns: [
        'post_type', 'id', 'uuid', 'entity_id', 'url',
        'title', 'author', 'author_id', 'author_url', 'school', 'content',
        'likes', 'likes_status',
  ...
  return [{...projectDetail(d.data, target.post_type), ...projectMetrics(d.data.frequencyData)}];
})()
` },
    ],
});
